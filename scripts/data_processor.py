from utility_functions import calc_feat_dim, spectrogram_from_file

from char_to_indx import text_to_int_sequence
...
class AudioGenerator():
    ...
    def shuffle_data_by_partition(self, partition):
        ...
        if partition == 'train':
            ...
            raise log_writer("Invalid partition. "
                "Must be train/validation") 
    ...
    def load_metadata_from_desc_file(self, desc_file, partition):
        ...
        if partition == 'train':
            ...
            raise log_writer("Invalid partition to load metadata. "
